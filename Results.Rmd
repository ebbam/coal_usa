...
res_vectest = rbind(c(lvar, pval$statistic$method, pval$statistic$p.value, result), c(lvar, pval$statistic$method, pval$statistic$p.value, result), c(lvar, pval$statistic$method, pval$statistic$p.value, result))
