...
The following script conducts the main typology/clustering analysis reported in the manuscript.

The script produces the results reported in:
- Main text
- Figures 4-5
- Data used to create Figure 6 in main_econometrics.Rmd (cc_clusters_251.xlsx)
